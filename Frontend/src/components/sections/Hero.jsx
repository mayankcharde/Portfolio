        ...
        >
          {available && (
            ...
            >
              ...
              <span className="text-[10px] font-bold uppercase tracking-[0.2em] text-green-400/90">
          ...
          <motion.p
            variants={itemVariants}
            className="text-primary/70 font-bold uppercase tracking-[0.3em] text-xs mb-4"
          >
            Hey there, I'm 👋
          </motion.p>
          ...
          <motion.h1
            variants={itemVariants}
            className="text-5xl sm:text-6xl md:text-7xl lg:text-8xl font-heading font-black tracking-tighter mb-4 leading-[0.95]"
          >
          ...
          <motion.div
            variants={itemVariants}
            className="text-lg sm:text-xl md:text-2xl font-heading font-semibold text-accent/70 mb-8 h-10 flex items-center"
          >
          ...
          <motion.p
            variants={itemVariants}
            className="text-muted text-base max-w-lg mb-10 leading-relaxed"
          >
            {bio}
          </motion.p>
